<?php
/**
 * File for class EzPedidosStructPedidoItem
 * @package EzPedidos
 * @subpackage Structs
 * @date 2015-03-31
 */
/**
 * This class stands for EzPedidosStructPedidoItem originally named PedidoItem
 * @package EzPedidos
 * @subpackage Structs
 * @date 2015-03-31
 */
class EzPedidosStructPedidoItem extends EzPedidosWsdlClass
{
    /**

<?php
/**
 * File for class EzClientesStructPacoteProduto
 * @package EzClientes
 * @subpackage Structs
 * @date 2015-03-31
 */
/**
 * This class stands for EzClientesStructPacoteProduto originally named PacoteProduto
 * @package EzClientes
 * @subpackage Structs
 * @date 2015-03-31
 */
class EzClientesStructPacoteProduto extends EzClientesWsdlClass
{
    /**
     * The Data
     * @var dateTime

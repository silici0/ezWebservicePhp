<?php
/**
 * File for class EzClientesStructEstoque
 * @package EzClientes
 * @subpackage Structs
 * @date 2015-03-31
 */
/**
 * This class stands for EzClientesStructEstoque originally named Estoque
 * @package EzClientes
 * @subpackage Structs
 * @date 2015-03-31
 */
class EzClientesStructEstoque extends EzClientesWsdlClass
{
    /**
     ...
     * @return EzClientesStructEstoque
     */

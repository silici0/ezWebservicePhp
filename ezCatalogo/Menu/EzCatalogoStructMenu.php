<?php
/**
 * File for class EzCatalogoStructMenu
 * @package EzCatalogo
 * @subpackage Structs
 * @date 2015-03-31
 */
/**
 * This class stands for EzCatalogoStructMenu originally named Menu
 * @package EzCatalogo
 * @subpackage Structs
 * @date 2015-03-31
 */
class EzCatalogoStructMenu extends EzCatalogoWsdlClass
{
    /**
     * The Ativo
     * @var boolean

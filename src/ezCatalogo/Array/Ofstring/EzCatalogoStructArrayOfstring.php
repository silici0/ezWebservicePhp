<?php
/**
 * File for class EzCatalogoStructArrayOfstring
 * @package EzCatalogo
 * @subpackage Structs
 * @date 2015-03-31
 */
/**
 * This class stands for EzCatalogoStructArrayOfstring originally named ArrayOfstring
 * @package EzCatalogo
 * @subpackage Structs
 * @date 2015-03-31
 */
class EzCatalogoStructArrayOfstring extends EzCatalogoWsdlClass
{
    /**
     * The string
     * @var string

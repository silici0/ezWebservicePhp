<?php
/**
 * File for class EzClientesStructMarca
 * @package EzClientes
 * @subpackage Structs
 * @date 2015-03-31
 */
/**
 * This class stands for EzClientesStructMarca originally named Marca
 * @package EzClientes
 * @subpackage Structs
 * @date 2015-03-31
 */
class EzClientesStructMarca extends EzClientesWsdlClass
{
    /**
     * The Ativo
     * @var boolean

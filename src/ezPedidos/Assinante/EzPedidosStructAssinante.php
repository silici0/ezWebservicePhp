<?php
/**
 * File for class EzPedidosStructAssinante
 * @package EzPedidos
 * @subpackage Structs
 * @date 2015-03-31
 */
/**
 * This class stands for EzPedidosStructAssinante originally named Assinante
 * @package EzPedidos
 * @subpackage Structs
 * @date 2015-03-31
 */
class EzPedidosStructAssinante extends EzPedidosWsdlClass
{
    /**
     * The DataCadastro
     * @var dateTime

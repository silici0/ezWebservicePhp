<?php
/**
 * File for class EzCatalogoStructPacoteProduto
 * @package EzCatalogo
 * @subpackage Structs
 * @date 2015-03-31
 */
/**
 * This class stands for EzCatalogoStructPacoteProduto originally named PacoteProduto
 * @package EzCatalogo
 * @subpackage Structs
 * @date 2015-03-31
 */
class EzCatalogoStructPacoteProduto extends EzCatalogoWsdlClass
{
    /**
     * The Data
     * @var dateTime

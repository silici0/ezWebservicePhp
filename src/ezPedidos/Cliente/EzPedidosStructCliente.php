<?php
/**
 * File for class EzPedidosStructCliente
 * @package EzPedidos
 * @subpackage Structs
 * @date 2015-03-31
 */
/**
 * This class stands for EzPedidosStructCliente originally named Cliente
 * @package EzPedidos
 * @subpackage Structs
 * @date 2015-03-31
 */
class EzPedidosStructCliente extends EzPedidosWsdlClass
{
    /**
     * The Apelido
     * @var string

<?php
/**
 * File for class EzPedidosStructPedido
 * @package EzPedidos
 * @subpackage Structs
 * @date 2015-03-31
 */
/**
 * This class stands for EzPedidosStructPedido originally named Pedido
 * @package EzPedidos
 * @subpackage Structs
 * @date 2015-03-31
 */
class EzPedidosStructPedido extends EzPedidosWsdlClass
{
    /**
     * The AfiliadoID
     * @var int
     ...
     * @var EzPedidosStructConfirmacaoPagamento
     */
     ...
     * @var EzPedidosStructFormaDePagamento
     */
    ...
    /**
     * The Itens
     * @var EzPedidosStructArrayOfPedidoItem
     */
    public $Itens;
    /**
     ...
     * @param EzPedidosStructConfirmacaoPagamento $_confirmacaoPagamento
     ...
     * @param EzPedidosStructFormaDePagamento $_formaDePagamento
     * @param string $_formaEntregaAlias
     * @param int $_formaEntregaID
     * @param string $_freteCodEnvio
     * @param EzPedidosStructArrayOfPedidoItem $_itens
     ...
     * @return EzPedidosStructConfirmacaoPagamento|null
     */
     ...
     * @param EzPedidosStructConfirmacaoPagamento $_confirmacaoPagamento the ConfirmacaoPagamento
     ...
     * @return EzPedidosStructFormaDePagamento|null
     */
     ...
     * @param EzPedidosStructFormaDePagamento $_formaDePagamento the FormaDePagamento
    ...
    /**
     * Get Itens value
     * @return EzPedidosStructArrayOfPedidoItem|null
     */
    ...
    /**
     * Set Itens value
     * @param EzPedidosStructArrayOfPedidoItem $_itens the Itens

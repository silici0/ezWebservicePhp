<?php
/**
 * File for class EzClientesStructPacote
 * @package EzClientes
 * @subpackage Structs
 * @date 2015-03-31
 */
/**
 * This class stands for EzClientesStructPacote originally named Pacote
 * @package EzClientes
 * @subpackage Structs
 * @date 2015-03-31
 */
class EzClientesStructPacote extends EzClientesWsdlClass
{
    /**
     * The CodigoBarra
     * @var string
    ...
    /**
     * The PacoteProdutos
     * @var EzClientesStructArrayOfPacoteProduto
     */
     ...
     * @param int $_pacoteID
     * @param EzClientesStructArrayOfPacoteProduto $_pacoteProdutos
     * @param int $_pedidoCodigo
     * @param int $_trackingStatus
     * @return EzClientesStructPacote
     */
     ...
     * @return EzClientesStructArrayOfPacoteProduto|null
     */
     ...
     * @param EzClientesStructArrayOfPacoteProduto $_pacoteProdutos the PacoteProdutos

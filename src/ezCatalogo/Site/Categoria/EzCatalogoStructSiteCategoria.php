<?php
/**
 * File for class EzCatalogoStructSiteCategoria
 * @package EzCatalogo
 * @subpackage Structs
 * @date 2015-03-31
 */
/**
 * This class stands for EzCatalogoStructSiteCategoria originally named SiteCategoria
 * @package EzCatalogo
 * @subpackage Structs
 * @date 2015-03-31
 */
class EzCatalogoStructSiteCategoria extends EzCatalogoWsdlClass
{
    /**
     * The Ativo
     * @var boolean

<?php
/**
 * File for class EzPedidosStructPacoteProduto
 * @package EzPedidos
 * @subpackage Structs
 * @date 2015-03-31
 */
/**
 * This class stands for EzPedidosStructPacoteProduto originally named PacoteProduto
 * @package EzPedidos
 * @subpackage Structs
 * @date 2015-03-31
 */
class EzPedidosStructPacoteProduto extends EzPedidosWsdlClass
{
    /**
     * The Data
     * @var dateTime

<?php
/**
 * File for class EzPedidosStructAcompanhamentoStatus
 * @package EzPedidos
 * @subpackage Structs
 * @date 2015-03-31
 */
/**
 * This class stands for EzPedidosStructAcompanhamentoStatus originally named AcompanhamentoStatus
 * @package EzPedidos
 * @subpackage Structs
 * @date 2015-03-31
 */
class EzPedidosStructAcompanhamentoStatus extends EzPedidosWsdlClass
{
    /**

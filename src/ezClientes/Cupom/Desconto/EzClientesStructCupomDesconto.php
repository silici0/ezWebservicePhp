<?php
/**
 * File for class EzClientesStructCupomDesconto
 * @package EzClientes
 * @subpackage Structs
 * @date 2015-03-31
 */
/**
 * This class stands for EzClientesStructCupomDesconto originally named CupomDesconto
 * @package EzClientes
 * @subpackage Structs
 * @date 2015-03-31
 */
class EzClientesStructCupomDesconto extends EzClientesWsdlClass
{
    /**
     * The Ativo
     * @var boolean
    ...
    {
        parent::__construct(array('Ativo'=>$_ativo,'Clube'=>$_clube,'ClubePalavraChave'=>$_clubePalavraChave,'ClubeTemplate'=>$_clubeTemplate,'ClubeTitulo'=>$_clubeTitulo,'Cupom'=>$_cupom,'DataFim'=>$_dataFim,'DataInicio'=>$_dataInicio,'Desconto'=>$_desconto,'FreteGratis'=>$_freteGratis,'LimiteUso'=>$_limiteUso,'Produtos'=>($_produtos instanceof EzClientesStructArrayOfstring)?$_produtos:new EzClientesStructArrayOfstring($_produtos),'TipoDesconto'=>$_tipoDesconto,'Titulo'=>$_titulo,'ValorDesconto'=>$_valorDesconto,'ValorMinimo'=>$_valorMinimo),false);
    }
    /**
     * Get Ativo value
     * @return boolean|null
    ...
    /**
     * Set Produtos value
     * @param EzClientesStructArrayOfstring $_produtos the Produtos

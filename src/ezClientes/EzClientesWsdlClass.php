<?php
/**
 * File for EzClientesWsdlClass to communicate with SOAP service
 * @package EzClientes
 * @date 2015-03-31
 */
/**
 * EzClientesWsdlClass to communicate with SOAP service
 * 
 * @package EzClientes
 * @date 2015-03-31
 */
class EzClientesWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
    /**
     ...
     * @var string
     */
    const VALUE_WSDL_URL = 'http://services03.ezcommerce.com.br/clientews.svc?wsdl';
    /**
    ...
    /**
     * Constructor
     * @uses EzClientesWsdlClass::setLastError()
     * @uses EzClientesWsdlClass::initSoapClient()
     * @uses EzClientesWsdlClass::initInternArrayToIterate()
     * @uses EzClientesWsdlClass::_set()
     ...
     * @return EzClientesWsdlClass|null
     */
    public static function __set_state(array $_array,$_className = __CLASS__)
    {
        if(class_exists($_className))
        {
            ...
            if(is_object($object) && is_subclass_of($object,'EzClientesWsdlClass'))
            {
     ...
     * @uses EzClientesClassMap::classMap()
     * @uses EzClientesWsdlClass::getDefaultWsdlOptions()
     * @uses EzClientesWsdlClass::getSoapClientClassName()
     * @uses EzClientesWsdlClass::setSoapClient()
     * @param array $_wsdlOptions WSDL options
     * @return void
     */
    public function initSoapClient($_wsdlOptions)
    {
        if(class_exists('EzClientesClassMap',true))
        {
            $wsdlOptions = array();
            $wsdlOptions['classmap'] = EzClientesClassMap::classMap();
     ...
     * If a class is named as {EzClientes}SoapClient, then this is the class that will be used.
    ...
    {
        if(class_exists('EzClientesSoapClient') && is_subclass_of('EzClientesSoapClient','SoapClient'))
            return 'EzClientesSoapClient';
        else
            return 'SoapClient';
    }
    /**
     * Method returning all default options values
     * @uses EzClientesWsdlClass::WSDL_CACHE_WSDL
     * @uses EzClientesWsdlClass::WSDL_COMPRESSION
     * @uses EzClientesWsdlClass::WSDL_CONNECTION_TIMEOUT
     * @uses EzClientesWsdlClass::WSDL_ENCODING
     * @uses EzClientesWsdlClass::WSDL_EXCEPTIONS
     * @uses EzClientesWsdlClass::WSDL_FEATURES
     * @uses EzClientesWsdlClass::WSDL_LOGIN
     * @uses EzClientesWsdlClass::WSDL_PASSWORD
     * @uses EzClientesWsdlClass::WSDL_SOAP_VERSION
     * @uses EzClientesWsdlClass::WSDL_STREAM_CONTEXT
     * @uses EzClientesWsdlClass::WSDL_TRACE
     * @uses EzClientesWsdlClass::WSDL_TYPEMAP
     * @uses EzClientesWsdlClass::WSDL_URL
     * @uses EzClientesWsdlClass::VALUE_WSDL_URL
     * @uses EzClientesWsdlClass::WSDL_USER_AGENT
     * @uses EzClientesWsdlClass::WSDL_PROXY_HOST
     * @uses EzClientesWsdlClass::WSDL_PROXY_PORT
     * @uses EzClientesWsdlClass::WSDL_PROXY_LOGIN
     * @uses EzClientesWsdlClass::WSDL_PROXY_PASSWORD
     * @uses EzClientesWsdlClass::WSDL_LOCAL_CERT
     * @uses EzClientesWsdlClass::WSDL_PASSPHRASE
     * @uses EzClientesWsdlClass::WSDL_AUTHENTICATION
     * @uses EzClientesWsdlClass::WSDL_SSL_METHOD
     ...
     * @uses EzClientesWsdlClass::getSoapClient()
     * @uses EzClientesWsdlClass::getFormatedXml()
     ...
     * @uses EzClientesWsdlClass::getSoapClient()
     * @uses EzClientesWsdlClass::convertStringHeadersToArray()
     ...
     * @uses EzClientesWsdlClass::count()
     * @return int
     */
     ...
     * @uses EzClientesWsdlClass::getInternArrayToIterate()
     * @uses EzClientesWsdlClass::getInternArrayToIterateIsArray()
     * @return int
     */
     ...
     * @uses EzClientesWsdlClass::offsetGet()
     * @return mixed
     */
     ...
     * @uses EzClientesWsdlClass::getInternArrayToIterateOffset()
     * @uses EzClientesWsdlClass::setInternArrayToIterateOffset()
     * @return int
     */
     ...
     * @uses EzClientesWsdlClass::getInternArrayToIterateOffset()
     * @uses EzClientesWsdlClass::offsetExists()
     * @return bool true|false
     */
     ...
     * @see EzClientesWsdlClass::offsetGet()
     * @uses EzClientesWsdlClass::offsetGet()
     * @param int $_index
     * @return mixed
     */
     ...
     * @uses EzClientesWsdlClass::getAttributeName()
     * @uses EzClientesWsdlClass::__toString()
     * @uses EzClientesWsdlClass::_set()
     * @uses EzClientesWsdlClass::_get()
     * @uses EzClientesWsdlClass::setInternArrayToIterate()
     * @uses EzClientesWsdlClass::setInternArrayToIterateIsArray()
     * @uses EzClientesWsdlClass::setInternArrayToIterateOffset()
     ...
     * @uses EzClientesWsdlClass::item()
     * @uses EzClientesWsdlClass::length()
     * @return mixed
     */

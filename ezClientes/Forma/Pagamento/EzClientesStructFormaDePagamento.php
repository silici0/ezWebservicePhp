<?php
/**
 * File for class EzClientesStructFormaDePagamento
 * @package EzClientes
 * @subpackage Structs
 * @date 2015-03-31
 */
/**
 * This class stands for EzClientesStructFormaDePagamento originally named FormaDePagamento
 * @package EzClientes
 * @subpackage Structs
 * @date 2015-03-31
 */
class EzClientesStructFormaDePagamento extends EzClientesWsdlClass
{
    /**

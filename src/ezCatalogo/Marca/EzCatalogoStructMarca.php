<?php
/**
 * File for class EzCatalogoStructMarca
 * @package EzCatalogo
 * @subpackage Structs
 * @date 2015-03-31
 */
/**
 * This class stands for EzCatalogoStructMarca originally named Marca
 * @package EzCatalogo
 * @subpackage Structs
 * @date 2015-03-31
 */
class EzCatalogoStructMarca extends EzCatalogoWsdlClass
{
    /**
     * The Ativo
     * @var boolean

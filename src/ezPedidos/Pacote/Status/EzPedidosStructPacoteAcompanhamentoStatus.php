<?php
/**
 * File for class EzPedidosStructPacoteAcompanhamentoStatus
 * @package EzPedidos
 * @subpackage Structs
 * @date 2015-03-31
 */
/**
 * This class stands for EzPedidosStructPacoteAcompanhamentoStatus originally named PacoteAcompanhamentoStatus
 * @package EzPedidos
 * @subpackage Structs
 * @date 2015-03-31
 */
class EzPedidosStructPacoteAcompanhamentoStatus extends EzPedidosWsdlClass
{
    /**
     * The Data
     * @var dateTime

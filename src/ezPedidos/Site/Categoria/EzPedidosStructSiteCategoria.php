<?php
/**
 * File for class EzPedidosStructSiteCategoria
 * @package EzPedidos
 * @subpackage Structs
 * @date 2015-03-31
 */
/**
 * This class stands for EzPedidosStructSiteCategoria originally named SiteCategoria
 * @package EzPedidos
 * @subpackage Structs
 * @date 2015-03-31
 */
class EzPedidosStructSiteCategoria extends EzPedidosWsdlClass
{
    /**
     * The Ativo
     * @var boolean

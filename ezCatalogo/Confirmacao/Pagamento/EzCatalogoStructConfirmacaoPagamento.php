<?php
/**
 * File for class EzCatalogoStructConfirmacaoPagamento
 * @package EzCatalogo
 * @subpackage Structs
 * @date 2015-03-31
 */
/**
 * This class stands for EzCatalogoStructConfirmacaoPagamento originally named ConfirmacaoPagamento
 * @package EzCatalogo
 * @subpackage Structs
 * @date 2015-03-31
 */
class EzCatalogoStructConfirmacaoPagamento extends EzCatalogoWsdlClass
{
    /**

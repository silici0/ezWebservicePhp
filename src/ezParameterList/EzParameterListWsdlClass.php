<?php
/**
 * File for EzParameterListWsdlClass to communicate with SOAP service
 * @package EzParameterList
 * @date 2015-03-31
 */
/**
 * EzParameterListWsdlClass to communicate with SOAP service
 * 
 * @package EzParameterList
 * @date 2015-03-31
 */
class EzParameterListWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
    /**
     ...
     * @var string
     */
    const VALUE_WSDL_URL = 'http://services03.ezcommerce.com.br/Pages/ParameterList.aspx?wsdl';
    /**
    ...
    /**
     * Constructor
     * @uses EzParameterListWsdlClass::setLastError()
     * @uses EzParameterListWsdlClass::initSoapClient()
     * @uses EzParameterListWsdlClass::initInternArrayToIterate()
     * @uses EzParameterListWsdlClass::_set()
     ...
     * @return EzParameterListWsdlClass
     */
     ...
     * @return EzParameterListWsdlClass|null
     */
    public static function __set_state(array $_array,$_className = __CLASS__)
    {
        if(class_exists($_className))
        {
            ...
            if(is_object($object) && is_subclass_of($object,'EzParameterListWsdlClass'))
            {
     ...
     * @uses EzParameterListClassMap::classMap()
     * @uses EzParameterListWsdlClass::getDefaultWsdlOptions()
     * @uses EzParameterListWsdlClass::getSoapClientClassName()
     * @uses EzParameterListWsdlClass::setSoapClient()
     * @param array $_wsdlOptions WSDL options
     * @return void
     */
    public function initSoapClient($_wsdlOptions)
    {
        if(class_exists('EzParameterListClassMap',true))
        {
            $wsdlOptions = array();
            $wsdlOptions['classmap'] = EzParameterListClassMap::classMap();
     ...
     * If a class is named as {EzParameterList}SoapClient, then this is the class that will be used.
    ...
    {
        if(class_exists('EzParameterListSoapClient') && is_subclass_of('EzParameterListSoapClient','SoapClient'))
            return 'EzParameterListSoapClient';
        else
            return 'SoapClient';
    }
    /**
     * Method returning all default options values
     * @uses EzParameterListWsdlClass::WSDL_CACHE_WSDL
     * @uses EzParameterListWsdlClass::WSDL_COMPRESSION
     * @uses EzParameterListWsdlClass::WSDL_CONNECTION_TIMEOUT
     * @uses EzParameterListWsdlClass::WSDL_ENCODING
     * @uses EzParameterListWsdlClass::WSDL_EXCEPTIONS
     * @uses EzParameterListWsdlClass::WSDL_FEATURES
     * @uses EzParameterListWsdlClass::WSDL_LOGIN
     * @uses EzParameterListWsdlClass::WSDL_PASSWORD
     * @uses EzParameterListWsdlClass::WSDL_SOAP_VERSION
     * @uses EzParameterListWsdlClass::WSDL_STREAM_CONTEXT
     * @uses EzParameterListWsdlClass::WSDL_TRACE
     * @uses EzParameterListWsdlClass::WSDL_TYPEMAP
     * @uses EzParameterListWsdlClass::WSDL_URL
     * @uses EzParameterListWsdlClass::VALUE_WSDL_URL
     * @uses EzParameterListWsdlClass::WSDL_USER_AGENT
     * @uses EzParameterListWsdlClass::WSDL_PROXY_HOST
     * @uses EzParameterListWsdlClass::WSDL_PROXY_PORT
     * @uses EzParameterListWsdlClass::WSDL_PROXY_LOGIN
     * @uses EzParameterListWsdlClass::WSDL_PROXY_PASSWORD
     * @uses EzParameterListWsdlClass::WSDL_LOCAL_CERT
     * @uses EzParameterListWsdlClass::WSDL_PASSPHRASE
     * @uses EzParameterListWsdlClass::WSDL_AUTHENTICATION
     * @uses EzParameterListWsdlClass::WSDL_SSL_METHOD
     ...
     * @uses EzParameterListWsdlClass::getSoapClient()
     ...
     * @uses EzParameterListWsdlClass::getSoapClient()
     * @uses EzParameterListWsdlClass::getFormatedXml()
     ...
     * @uses EzParameterListWsdlClass::getSoapClient()
     * @uses EzParameterListWsdlClass::convertStringHeadersToArray()
     ...
     * @uses EzParameterListWsdlClass::count()
     * @return int
     */
     ...
     * @uses EzParameterListWsdlClass::getInternArrayToIterate()
     * @uses EzParameterListWsdlClass::getInternArrayToIterateIsArray()
     * @return int
     */
     ...
     * @uses EzParameterListWsdlClass::offsetGet()
     * @return mixed
     */
     ...
     * @uses EzParameterListWsdlClass::getInternArrayToIterateOffset()
     * @uses EzParameterListWsdlClass::setInternArrayToIterateOffset()
     * @return int
     */
     ...
     * @uses EzParameterListWsdlClass::getInternArrayToIterateOffset()
     * @uses EzParameterListWsdlClass::offsetExists()
     * @return bool true|false
     */
     ...
     * @see EzParameterListWsdlClass::offsetGet()
     * @uses EzParameterListWsdlClass::offsetGet()
     * @param int $_index
     * @return mixed
     */
     ...
     * @uses EzParameterListWsdlClass::getAttributeName()
     * @uses EzParameterListWsdlClass::__toString()
     * @uses EzParameterListWsdlClass::_set()
     * @uses EzParameterListWsdlClass::_get()
     * @uses EzParameterListWsdlClass::setInternArrayToIterate()
     * @uses EzParameterListWsdlClass::setInternArrayToIterateIsArray()
     * @uses EzParameterListWsdlClass::setInternArrayToIterateOffset()
     ...
     * @uses EzParameterListWsdlClass::item()
     * @return mixed
     */
     ...
     * @uses EzParameterListWsdlClass::item()
     * @uses EzParameterListWsdlClass::length()
     * @return mixed
     */

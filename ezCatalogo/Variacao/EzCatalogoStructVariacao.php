<?php
/**
 * File for class EzCatalogoStructVariacao
 * @package EzCatalogo
 * @subpackage Structs
 * @date 2015-03-31
 */
/**
 * This class stands for EzCatalogoStructVariacao originally named Variacao
 * @package EzCatalogo
 * @subpackage Structs
 * @date 2015-03-31
 */
class EzCatalogoStructVariacao extends EzCatalogoWsdlClass
{
    /**

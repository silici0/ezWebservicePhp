<?php
/**
 * File for class EzClientesStructPedido
 * @package EzClientes
 * @subpackage Structs
 * @date 2015-03-31
 */
/**
 * This class stands for EzClientesStructPedido originally named Pedido
 * @package EzClientes
 * @subpackage Structs
 * @date 2015-03-31
 */
class EzClientesStructPedido extends EzClientesWsdlClass
{
    /**
     * The AfiliadoID
     * @var int
     ...
     * @var EzClientesStructConfirmacaoPagamento
     */
     ...
     * @var EzClientesStructFormaDePagamento
     */
    ...
    /**
     * The Itens
     * @var EzClientesStructArrayOfPedidoItem
     */
    public $Itens;
    /**
     ...
     * @param EzClientesStructConfirmacaoPagamento $_confirmacaoPagamento
     ...
     * @param EzClientesStructFormaDePagamento $_formaDePagamento
     * @param string $_formaEntregaAlias
     * @param int $_formaEntregaID
     * @param string $_freteCodEnvio
     * @param EzClientesStructArrayOfPedidoItem $_itens
     ...
     * @return EzClientesStructConfirmacaoPagamento|null
     */
     ...
     * @param EzClientesStructConfirmacaoPagamento $_confirmacaoPagamento the ConfirmacaoPagamento
     * @return EzClientesStructConfirmacaoPagamento
     */
     ...
     * @return EzClientesStructFormaDePagamento|null
     */
     ...
     * @param EzClientesStructFormaDePagamento $_formaDePagamento the FormaDePagamento
     * @return EzClientesStructFormaDePagamento
     */
    ...
    /**
     * Get Itens value
     * @return EzClientesStructArrayOfPedidoItem|null
     */
    ...
    /**
     * Set Itens value
     * @param EzClientesStructArrayOfPedidoItem $_itens the Itens

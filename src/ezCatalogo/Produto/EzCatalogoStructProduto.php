<?php
/**
 * File for class EzCatalogoStructProduto
 * @package EzCatalogo
 * @subpackage Structs
 * @date 2015-03-31
 */
/**
 * This class stands for EzCatalogoStructProduto originally named Produto
 * @package EzCatalogo
 * @subpackage Structs
 * @date 2015-03-31
 */
class EzCatalogoStructProduto extends EzCatalogoWsdlClass
{
    /**
     * The Altura
     * @var double
    ...
    /**
     * The Associacoes
     * @var EzCatalogoStructArrayOfAssociacao
     */
    public $Associacoes;
    /**
     * The Ativo
     ...
     * @var EzCatalogoStructArrayOfCampoExtendido
     */
     ...
     * @var EzCatalogoStructArrayOfint
     */
     ...
     * @param EzCatalogoStructArrayOfAssociacao $_associacoes
     * @param boolean $_ativo
     * @param EzCatalogoStructArrayOfCampoExtendido $_camposExtendidos
     ...
     * @param EzCatalogoStructArrayOfint $_siteCategoriaAlternativas
     ...
     * @return EzCatalogoStructArrayOfAssociacao|null
     */
     ...
     * @param EzCatalogoStructArrayOfAssociacao $_associacoes the Associacoes
     ...
     * @return EzCatalogoStructArrayOfCampoExtendido|null
     */
     ...
     * @param EzCatalogoStructArrayOfCampoExtendido $_camposExtendidos the CamposExtendidos
     ...
     * @return EzCatalogoStructArrayOfint|null
     */
     ...
     * @param EzCatalogoStructArrayOfint $_siteCategoriaAlternativas the SiteCategoriaAlternativas

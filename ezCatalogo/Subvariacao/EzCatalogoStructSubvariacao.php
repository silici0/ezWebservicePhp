<?php
/**
 * File for class EzCatalogoStructSubvariacao
 * @package EzCatalogo
 * @subpackage Structs
 * @date 2015-03-31
 */
/**
 * This class stands for EzCatalogoStructSubvariacao originally named Subvariacao
 * @package EzCatalogo
 * @subpackage Structs
 * @date 2015-03-31
 */
class EzCatalogoStructSubvariacao extends EzCatalogoWsdlClass
{
    /**

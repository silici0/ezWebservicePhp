<?php
/**
 * File for class EzClientesStructPedidoItem
 * @package EzClientes
 * @subpackage Structs
 * @date 2015-03-31
 */
/**
 * This class stands for EzClientesStructPedidoItem originally named PedidoItem
 * @package EzClientes
 * @subpackage Structs
 * @date 2015-03-31
 */
class EzClientesStructPedidoItem extends EzClientesWsdlClass
{
    /**

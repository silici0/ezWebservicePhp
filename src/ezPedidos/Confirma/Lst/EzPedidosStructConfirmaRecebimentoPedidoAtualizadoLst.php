<?php
/**
 * File for class EzPedidosStructConfirmaRecebimentoPedidoAtualizadoLst
 * @package EzPedidos
 * @subpackage Structs
 * @date 2015-03-31
 */
/**
 * This class stands for EzPedidosStructConfirmaRecebimentoPedidoAtualizadoLst originally named ConfirmaRecebimentoPedidoAtualizadoLst
 * @package EzPedidos
 * @subpackage Structs
 * @date 2015-03-31
 */
class EzPedidosStructConfirmaRecebimentoPedidoAtualizadoLst extends EzPedidosWsdlClass
{
    /**
     * The arrProtocolo

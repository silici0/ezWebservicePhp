<?php
/**
 * File for class EzCatalogoStructEstoque
 * @package EzCatalogo
 * @subpackage Structs
 * @date 2015-03-31
 */
/**
 * This class stands for EzCatalogoStructEstoque originally named Estoque
 * @package EzCatalogo
 * @subpackage Structs
 * @date 2015-03-31
 */
class EzCatalogoStructEstoque extends EzCatalogoWsdlClass
{
    /**

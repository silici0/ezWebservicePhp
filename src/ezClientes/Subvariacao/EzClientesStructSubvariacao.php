<?php
/**
 * File for class EzClientesStructSubvariacao
 * @package EzClientes
 * @subpackage Structs
 * @date 2015-03-31
 */
/**
 * This class stands for EzClientesStructSubvariacao originally named Subvariacao
 * @package EzClientes
 * @subpackage Structs
 * @date 2015-03-31
 */
class EzClientesStructSubvariacao extends EzClientesWsdlClass
{
    /**
     ...
     * @return EzClientesStructSubvariacao
     */

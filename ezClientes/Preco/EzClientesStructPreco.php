<?php
/**
 * File for class EzClientesStructPreco
 * @package EzClientes
 * @subpackage Structs
 * @date 2015-03-31
 */
/**
 * This class stands for EzClientesStructPreco originally named Preco
 * @package EzClientes
 * @subpackage Structs
 * @date 2015-03-31
 */
class EzClientesStructPreco extends EzClientesWsdlClass
{
    /**

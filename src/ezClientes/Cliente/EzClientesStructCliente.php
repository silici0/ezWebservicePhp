<?php
/**
 * File for class EzClientesStructCliente
 * @package EzClientes
 * @subpackage Structs
 * @date 2015-03-31
 */
/**
 * This class stands for EzClientesStructCliente originally named Cliente
 * @package EzClientes
 * @subpackage Structs
 * @date 2015-03-31
 */
class EzClientesStructCliente extends EzClientesWsdlClass
{
    /**
     * The Apelido
     * @var string

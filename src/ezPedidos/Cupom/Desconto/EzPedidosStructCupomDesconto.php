<?php
/**
 * File for class EzPedidosStructCupomDesconto
 * @package EzPedidos
 * @subpackage Structs
 * @date 2015-03-31
 */
/**
 * This class stands for EzPedidosStructCupomDesconto originally named CupomDesconto
 * @package EzPedidos
 * @subpackage Structs
 * @date 2015-03-31
 */
class EzPedidosStructCupomDesconto extends EzPedidosWsdlClass
{
    /**
     * The Ativo
     * @var boolean
     ...
     * @param EzPedidosStructArrayOfstring $_produtos
    ...
    {
        parent::__construct(array('Ativo'=>$_ativo,'Clube'=>$_clube,'ClubePalavraChave'=>$_clubePalavraChave,'ClubeTemplate'=>$_clubeTemplate,'ClubeTitulo'=>$_clubeTitulo,'Cupom'=>$_cupom,'DataFim'=>$_dataFim,'DataInicio'=>$_dataInicio,'Desconto'=>$_desconto,'FreteGratis'=>$_freteGratis,'LimiteUso'=>$_limiteUso,'Produtos'=>($_produtos instanceof EzPedidosStructArrayOfstring)?$_produtos:new EzPedidosStructArrayOfstring($_produtos),'TipoDesconto'=>$_tipoDesconto,'Titulo'=>$_titulo,'ValorDesconto'=>$_valorDesconto,'ValorMinimo'=>$_valorMinimo),false);
    }
    /**
     * Get Ativo value
     * @return boolean|null
    ...
    /**
     * Set Produtos value
     * @param EzPedidosStructArrayOfstring $_produtos the Produtos

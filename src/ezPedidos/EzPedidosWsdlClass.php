 ...
 */
/**
 * EzPedidosWsdlClass to communicate with SOAP service
 * 
 * @package EzPedidos
 * @date 2015-03-31
 */
class EzPedidosWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
    /**
     ...
     * @var string
     */
    const VALUE_WSDL_URL = 'http://services03.ezcommerce.com.br/pedidows.svc?wsdl';
    /**
    ...
    /**
     * Constructor
     * @uses EzPedidosWsdlClass::setLastError()
     * @uses EzPedidosWsdlClass::initSoapClient()
     * @uses EzPedidosWsdlClass::initInternArrayToIterate()
     * @uses EzPedidosWsdlClass::_set()
     ...
     * @return EzPedidosWsdlClass|null
     */
    public static function __set_state(array $_array,$_className = __CLASS__)
    {
        if(class_exists($_className))
        {
            ...
            if(is_object($object) && is_subclass_of($object,'EzPedidosWsdlClass'))
            {
     ...
     * @uses EzPedidosClassMap::classMap()
     * @uses EzPedidosWsdlClass::getDefaultWsdlOptions()
     * @uses EzPedidosWsdlClass::getSoapClientClassName()
     * @uses EzPedidosWsdlClass::setSoapClient()
     ...
     * If a class is named as {EzPedidos}SoapClient, then this is the class that will be used.
    ...
    {
        if(class_exists('EzPedidosSoapClient') && is_subclass_of('EzPedidosSoapClient','SoapClient'))
            return 'EzPedidosSoapClient';
        else
            return 'SoapClient';
    }
    /**
     * Method returning all default options values
     * @uses EzPedidosWsdlClass::WSDL_CACHE_WSDL
     * @uses EzPedidosWsdlClass::WSDL_COMPRESSION
     * @uses EzPedidosWsdlClass::WSDL_CONNECTION_TIMEOUT
     * @uses EzPedidosWsdlClass::WSDL_ENCODING
     * @uses EzPedidosWsdlClass::WSDL_EXCEPTIONS
     * @uses EzPedidosWsdlClass::WSDL_FEATURES
     * @uses EzPedidosWsdlClass::WSDL_LOGIN
     * @uses EzPedidosWsdlClass::WSDL_PASSWORD
     * @uses EzPedidosWsdlClass::WSDL_SOAP_VERSION
     * @uses EzPedidosWsdlClass::WSDL_STREAM_CONTEXT
     * @uses EzPedidosWsdlClass::WSDL_TRACE
     * @uses EzPedidosWsdlClass::WSDL_TYPEMAP
     * @uses EzPedidosWsdlClass::WSDL_URL
     * @uses EzPedidosWsdlClass::VALUE_WSDL_URL
     * @uses EzPedidosWsdlClass::WSDL_USER_AGENT
     * @uses EzPedidosWsdlClass::WSDL_PROXY_HOST
     * @uses EzPedidosWsdlClass::WSDL_PROXY_PORT
     * @uses EzPedidosWsdlClass::WSDL_PROXY_LOGIN
     * @uses EzPedidosWsdlClass::WSDL_PROXY_PASSWORD
     * @uses EzPedidosWsdlClass::WSDL_LOCAL_CERT
     * @uses EzPedidosWsdlClass::WSDL_PASSPHRASE
     * @uses EzPedidosWsdlClass::WSDL_AUTHENTICATION
     * @uses EzPedidosWsdlClass::WSDL_SSL_METHOD
     ...
     * @uses EzPedidosWsdlClass::getSoapClient()
     * @uses EzPedidosWsdlClass::getFormatedXml()
     ...
     * @uses EzPedidosWsdlClass::getSoapClient()
     * @uses EzPedidosWsdlClass::convertStringHeadersToArray()
     ...
     * @uses EzPedidosWsdlClass::getInternArrayToIterate()
     * @uses EzPedidosWsdlClass::getInternArrayToIterateIsArray()
     * @return int
     */
     ...
     * @uses EzPedidosWsdlClass::offsetGet()
     * @return mixed
     */
     ...
     * @uses EzPedidosWsdlClass::getInternArrayToIterateOffset()
     * @uses EzPedidosWsdlClass::setInternArrayToIterateOffset()
     * @return int
     */
     ...
     * @uses EzPedidosWsdlClass::getInternArrayToIterateOffset()
     * @uses EzPedidosWsdlClass::offsetExists()
     * @return bool true|false
     */
     ...
     * @see EzPedidosWsdlClass::offsetGet()
     * @uses EzPedidosWsdlClass::offsetGet()
     * @param int $_index
     * @return mixed
     */
     ...
     * @uses EzPedidosWsdlClass::getAttributeName()
     * @uses EzPedidosWsdlClass::__toString()
     * @uses EzPedidosWsdlClass::_set()
     * @uses EzPedidosWsdlClass::_get()
     * @uses EzPedidosWsdlClass::setInternArrayToIterate()
     * @uses EzPedidosWsdlClass::setInternArrayToIterateIsArray()
     * @uses EzPedidosWsdlClass::setInternArrayToIterateOffset()
     ...
     * @uses EzPedidosWsdlClass::item()
     * @uses EzPedidosWsdlClass::length()
     * @return mixed
     */

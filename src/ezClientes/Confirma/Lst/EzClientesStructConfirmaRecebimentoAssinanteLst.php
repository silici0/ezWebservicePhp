<?php
/**
 * File for class EzClientesStructConfirmaRecebimentoAssinanteLst
 * @package EzClientes
 * @subpackage Structs
 * @date 2015-03-31
 */
/**
 * This class stands for EzClientesStructConfirmaRecebimentoAssinanteLst originally named ConfirmaRecebimentoAssinanteLst
 * @package EzClientes
 * @subpackage Structs
 * @date 2015-03-31
 */
class EzClientesStructConfirmaRecebimentoAssinanteLst extends EzClientesWsdlClass
{
    /**
     * The arrProtocolo
    ...
    public $arrProtocolo;
    /**
     * Constructor method for ConfirmaRecebimentoAssinanteLst
     * @see parent::__construct()
     * @param EzClientesStructArrayOfstring $_arrProtocolo
     * @return EzClientesStructConfirmaRecebimentoAssinanteLst
     */

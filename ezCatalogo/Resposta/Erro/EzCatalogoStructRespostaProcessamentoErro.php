<?php
/**
 * File for class EzCatalogoStructRespostaProcessamentoErro
 * @package EzCatalogo
 * @subpackage Structs
 * @date 2015-03-31
 */
/**
 * This class stands for EzCatalogoStructRespostaProcessamentoErro originally named RespostaProcessamentoErro
 * @package EzCatalogo
 * @subpackage Structs
 * @date 2015-03-31
 */
class EzCatalogoStructRespostaProcessamentoErro extends EzCatalogoWsdlClass
{
    /**
     * The CodigoErro
     * @var int

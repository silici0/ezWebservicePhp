<?php
/**
 * File for class EzPedidosStructAdicionarProdutoPacote
 * @package EzPedidos
 * @subpackage Structs
 * @date 2015-03-31
 */
/**
 * This class stands for EzPedidosStructAdicionarProdutoPacote originally named AdicionarProdutoPacote
 * @package EzPedidos
 * @subpackage Structs
 * @date 2015-03-31
 */
class EzPedidosStructAdicionarProdutoPacote extends EzPedidosWsdlClass
{
    /**
     * The PacoteProduto
    ...
    /**
     * Constructor method for AdicionarProdutoPacote
     * @see parent::__construct()
     * @param EzPedidosStructArrayOfPacoteProduto $_pacoteProduto
     * @return EzPedidosStructAdicionarProdutoPacote
     */

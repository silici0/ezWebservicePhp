<?php
/**
 * File for class EzClientesStructStatusPedido
 * @package EzClientes
 * @subpackage Structs
 * @date 2015-03-31
 */
/**
 * This class stands for EzClientesStructStatusPedido originally named StatusPedido
 * @package EzClientes
 * @subpackage Structs
 * @date 2015-03-31
 */
class EzClientesStructStatusPedido extends EzClientesWsdlClass
{
    /**
     ...
     * @return EzClientesStructStatusPedido
     */

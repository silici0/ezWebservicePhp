<?php
/**
 * File for class EzPedidosStructPedidoAcompanhamento
 * @package EzPedidos
 * @subpackage Structs
 * @date 2015-03-31
 */
/**
 * This class stands for EzPedidosStructPedidoAcompanhamento originally named PedidoAcompanhamento
 * @package EzPedidos
 * @subpackage Structs
 * @date 2015-03-31
 */
class EzPedidosStructPedidoAcompanhamento extends EzPedidosWsdlClass
{
    /**
     * The DataAtualizacao
     * @var dateTime

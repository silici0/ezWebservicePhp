<?php
/**
 * File for class EzClientesStructFornecedor
 * @package EzClientes
 * @subpackage Structs
 * @date 2015-03-31
 */
/**
 * This class stands for EzClientesStructFornecedor originally named Fornecedor
 * @package EzClientes
 * @subpackage Structs
 * @date 2015-03-31
 */
class EzClientesStructFornecedor extends EzClientesWsdlClass
{
    /**
     * The Contato
     * @var string
     ...
     * @param string $_url
     * @return EzClientesStructFornecedor
     */

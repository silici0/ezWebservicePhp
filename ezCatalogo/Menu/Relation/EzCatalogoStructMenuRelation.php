<?php
/**
 * File for class EzCatalogoStructMenuRelation
 * @package EzCatalogo
 * @subpackage Structs
 * @date 2015-03-31
 */
/**
 * This class stands for EzCatalogoStructMenuRelation originally named MenuRelation
 * @package EzCatalogo
 * @subpackage Structs
 * @date 2015-03-31
 */
class EzCatalogoStructMenuRelation extends EzCatalogoWsdlClass
{
    /**
     * The CategoriaID
     * @var int

<?php
/**
 * File for class EzCatalogoStructPreco
 * @package EzCatalogo
 * @subpackage Structs
 * @date 2015-03-31
 */
/**
 * This class stands for EzCatalogoStructPreco originally named Preco
 * @package EzCatalogo
 * @subpackage Structs
 * @date 2015-03-31
 */
class EzCatalogoStructPreco extends EzCatalogoWsdlClass
{
    /**

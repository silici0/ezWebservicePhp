<?php
/**
 * File for class EzCatalogoStructPedidoAcompanhamento
 * @package EzCatalogo
 * @subpackage Structs
 * @date 2015-03-31
 */
/**
 * This class stands for EzCatalogoStructPedidoAcompanhamento originally named PedidoAcompanhamento
 * @package EzCatalogo
 * @subpackage Structs
 * @date 2015-03-31
 */
class EzCatalogoStructPedidoAcompanhamento extends EzCatalogoWsdlClass
{
    /**
     * The DataAtualizacao
     * @var dateTime

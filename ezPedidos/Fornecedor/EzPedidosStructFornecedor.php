<?php
/**
 * File for class EzPedidosStructFornecedor
 * @package EzPedidos
 * @subpackage Structs
 * @date 2015-03-31
 */
/**
 * This class stands for EzPedidosStructFornecedor originally named Fornecedor
 * @package EzPedidos
 * @subpackage Structs
 * @date 2015-03-31
 */
class EzPedidosStructFornecedor extends EzPedidosWsdlClass
{
    /**
     * The Contato
     * @var string
     ...
     * @param string $_url
     * @return EzPedidosStructFornecedor
     */

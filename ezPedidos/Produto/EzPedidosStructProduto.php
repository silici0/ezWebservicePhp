<?php
/**
 * File for class EzPedidosStructProduto
 * @package EzPedidos
 * @subpackage Structs
 * @date 2015-03-31
 */
/**
 * This class stands for EzPedidosStructProduto originally named Produto
 * @package EzPedidos
 * @subpackage Structs
 * @date 2015-03-31
 */
class EzPedidosStructProduto extends EzPedidosWsdlClass
{
    /**
     * The Altura
     * @var double
    ...
    /**
     * The Associacoes
     * @var EzPedidosStructArrayOfAssociacao
     */
    public $Associacoes;
    /**
     * The Ativo
     ...
     * @var EzPedidosStructArrayOfCampoExtendido
     */
     ...
     * @param EzPedidosStructArrayOfAssociacao $_associacoes
     * @param boolean $_ativo
     * @param EzPedidosStructArrayOfCampoExtendido $_camposExtendidos
     ...
     * @param EzPedidosStructArrayOfint $_siteCategoriaAlternativas
     ...
     * @return EzPedidosStructArrayOfAssociacao|null
     */
     ...
     * @param EzPedidosStructArrayOfAssociacao $_associacoes the Associacoes
     ...
     * @return EzPedidosStructArrayOfCampoExtendido|null
     */
     ...
     * @param EzPedidosStructArrayOfCampoExtendido $_camposExtendidos the CamposExtendidos
     ...
     * @return EzPedidosStructArrayOfint|null
     */
     ...
     * @param EzPedidosStructArrayOfint $_siteCategoriaAlternativas the SiteCategoriaAlternativas

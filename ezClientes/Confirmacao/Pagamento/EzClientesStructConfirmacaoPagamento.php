<?php
/**
 * File for class EzClientesStructConfirmacaoPagamento
 * @package EzClientes
 * @subpackage Structs
 * @date 2015-03-31
 */
/**
 * This class stands for EzClientesStructConfirmacaoPagamento originally named ConfirmacaoPagamento
 * @package EzClientes
 * @subpackage Structs
 * @date 2015-03-31
 */
class EzClientesStructConfirmacaoPagamento extends EzClientesWsdlClass
{
    /**

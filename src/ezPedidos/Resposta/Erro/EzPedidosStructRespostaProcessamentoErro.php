<?php
/**
 * File for class EzPedidosStructRespostaProcessamentoErro
 * @package EzPedidos
 * @subpackage Structs
 * @date 2015-03-31
 */
/**
 * This class stands for EzPedidosStructRespostaProcessamentoErro originally named RespostaProcessamentoErro
 * @package EzPedidos
 * @subpackage Structs
 * @date 2015-03-31
 */
class EzPedidosStructRespostaProcessamentoErro extends EzPedidosWsdlClass
{
    /**
     * The CodigoErro
     * @var int

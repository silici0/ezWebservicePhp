<?php
/**
 * File for class EzPedidosStructStatusPedido
 * @package EzPedidos
 * @subpackage Structs
 * @date 2015-03-31
 */
/**
 * This class stands for EzPedidosStructStatusPedido originally named StatusPedido
 * @package EzPedidos
 * @subpackage Structs
 * @date 2015-03-31
 */
class EzPedidosStructStatusPedido extends EzPedidosWsdlClass
{
    /**

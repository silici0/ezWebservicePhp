<?php
/**
 * File for class EzPedidosStructRemoverProdutoPacoteEntrega
 * @package EzPedidos
 * @subpackage Structs
 * @date 2015-03-31
 */
/**
 * This class stands for EzPedidosStructRemoverProdutoPacoteEntrega originally named RemoverProdutoPacoteEntrega
 * @package EzPedidos
 * @subpackage Structs
 * @date 2015-03-31
 */
class EzPedidosStructRemoverProdutoPacoteEntrega extends EzPedidosWsdlClass
{
    /**
     * The PacoteProduto
    ...
    /**
     * Constructor method for RemoverProdutoPacoteEntrega
     * @see parent::__construct()
     * @param EzPedidosStructArrayOfPacoteEntregaItem $_pacoteProduto
     * @return EzPedidosStructRemoverProdutoPacoteEntrega
     */

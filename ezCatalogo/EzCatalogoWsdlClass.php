<?php
/**
 * File for EzCatalogoWsdlClass to communicate with SOAP service
 * @package EzCatalogo
 * @date 2015-03-31
 */
/**
 * EzCatalogoWsdlClass to communicate with SOAP service
 * 
 * @package EzCatalogo
 * @date 2015-03-31
 */
class EzCatalogoWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
    /**
     ...
     * @var string
     */
    const VALUE_WSDL_URL = 'http://services03.ezcommerce.com.br/catalogows.svc?wsdl';
    /**
    ...
    /**
     * Constructor
     * @uses EzCatalogoWsdlClass::setLastError()
     * @uses EzCatalogoWsdlClass::initSoapClient()
     * @uses EzCatalogoWsdlClass::initInternArrayToIterate()
     * @uses EzCatalogoWsdlClass::_set()
     ...
     * @return EzCatalogoWsdlClass|null
     */
    public static function __set_state(array $_array,$_className = __CLASS__)
    {
        if(class_exists($_className))
        {
            ...
            if(is_object($object) && is_subclass_of($object,'EzCatalogoWsdlClass'))
            {
     ...
     * @uses EzCatalogoClassMap::classMap()
     * @uses EzCatalogoWsdlClass::getDefaultWsdlOptions()
     * @uses EzCatalogoWsdlClass::getSoapClientClassName()
     * @uses EzCatalogoWsdlClass::setSoapClient()
     * @param array $_wsdlOptions WSDL options
     * @return void
     */
    public function initSoapClient($_wsdlOptions)
    {
        if(class_exists('EzCatalogoClassMap',true))
        {
            $wsdlOptions = array();
            $wsdlOptions['classmap'] = EzCatalogoClassMap::classMap();
     ...
     * If a class is named as {EzCatalogo}SoapClient, then this is the class that will be used.
    ...
    {
        if(class_exists('EzCatalogoSoapClient') && is_subclass_of('EzCatalogoSoapClient','SoapClient'))
            return 'EzCatalogoSoapClient';
        else
            return 'SoapClient';
    }
    /**
     * Method returning all default options values
     * @uses EzCatalogoWsdlClass::WSDL_CACHE_WSDL
     * @uses EzCatalogoWsdlClass::WSDL_COMPRESSION
     * @uses EzCatalogoWsdlClass::WSDL_CONNECTION_TIMEOUT
     * @uses EzCatalogoWsdlClass::WSDL_ENCODING
     * @uses EzCatalogoWsdlClass::WSDL_EXCEPTIONS
     * @uses EzCatalogoWsdlClass::WSDL_FEATURES
     * @uses EzCatalogoWsdlClass::WSDL_LOGIN
     * @uses EzCatalogoWsdlClass::WSDL_PASSWORD
     * @uses EzCatalogoWsdlClass::WSDL_SOAP_VERSION
     * @uses EzCatalogoWsdlClass::WSDL_STREAM_CONTEXT
     * @uses EzCatalogoWsdlClass::WSDL_TRACE
     * @uses EzCatalogoWsdlClass::WSDL_TYPEMAP
     * @uses EzCatalogoWsdlClass::WSDL_URL
     * @uses EzCatalogoWsdlClass::VALUE_WSDL_URL
     * @uses EzCatalogoWsdlClass::WSDL_USER_AGENT
     * @uses EzCatalogoWsdlClass::WSDL_PROXY_HOST
     * @uses EzCatalogoWsdlClass::WSDL_PROXY_PORT
     * @uses EzCatalogoWsdlClass::WSDL_PROXY_LOGIN
     * @uses EzCatalogoWsdlClass::WSDL_PROXY_PASSWORD
     * @uses EzCatalogoWsdlClass::WSDL_LOCAL_CERT
     * @uses EzCatalogoWsdlClass::WSDL_PASSPHRASE
     * @uses EzCatalogoWsdlClass::WSDL_AUTHENTICATION
     * @uses EzCatalogoWsdlClass::WSDL_SSL_METHOD
     ...
     * @uses EzCatalogoWsdlClass::getSoapClient()
     * @uses EzCatalogoWsdlClass::getFormatedXml()
     ...
     * @uses EzCatalogoWsdlClass::getSoapClient()
     * @uses EzCatalogoWsdlClass::convertStringHeadersToArray()
     ...
     * @uses EzCatalogoWsdlClass::count()
     * @return int
     */
     ...
     * @uses EzCatalogoWsdlClass::getInternArrayToIterate()
     * @uses EzCatalogoWsdlClass::getInternArrayToIterateIsArray()
     * @return int
     */
     ...
     * @uses EzCatalogoWsdlClass::offsetGet()
     * @return mixed
     */
     ...
     * @uses EzCatalogoWsdlClass::getInternArrayToIterateOffset()
     * @uses EzCatalogoWsdlClass::setInternArrayToIterateOffset()
     * @return int
     */
     ...
     * @uses EzCatalogoWsdlClass::getInternArrayToIterateOffset()
     * @uses EzCatalogoWsdlClass::offsetExists()
     * @return bool true|false
     */
     ...
     * @see EzCatalogoWsdlClass::offsetGet()
     * @uses EzCatalogoWsdlClass::offsetGet()
     * @param int $_index
     * @return mixed
     */
     ...
     * @uses EzCatalogoWsdlClass::getAttributeName()
     * @uses EzCatalogoWsdlClass::__toString()
     * @uses EzCatalogoWsdlClass::_set()
     * @uses EzCatalogoWsdlClass::_get()
     * @uses EzCatalogoWsdlClass::setInternArrayToIterate()
     * @uses EzCatalogoWsdlClass::setInternArrayToIterateIsArray()
     * @uses EzCatalogoWsdlClass::setInternArrayToIterateOffset()
     ...
     * @uses EzCatalogoWsdlClass::item()
     * @uses EzCatalogoWsdlClass::length()
     * @return mixed
     */

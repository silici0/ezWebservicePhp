<?php
/**
 * File for class EzClientesStructMenu
 * @package EzClientes
 * @subpackage Structs
 * @date 2015-03-31
 */
/**
 * This class stands for EzClientesStructMenu originally named Menu
 * @package EzClientes
 * @subpackage Structs
 * @date 2015-03-31
 */
class EzClientesStructMenu extends EzClientesWsdlClass
{
    /**
     * The Ativo
     * @var boolean

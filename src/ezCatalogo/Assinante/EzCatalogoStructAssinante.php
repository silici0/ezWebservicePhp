<?php
/**
 * File for class EzCatalogoStructAssinante
 * @package EzCatalogo
 * @subpackage Structs
 * @date 2015-03-31
 */
/**
 * This class stands for EzCatalogoStructAssinante originally named Assinante
 * @package EzCatalogo
 * @subpackage Structs
 * @date 2015-03-31
 */
class EzCatalogoStructAssinante extends EzCatalogoWsdlClass
{
    /**
     * The DataCadastro
     * @var dateTime

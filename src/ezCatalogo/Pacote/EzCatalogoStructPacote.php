<?php
/**
 * File for class EzCatalogoStructPacote
 * @package EzCatalogo
 * @subpackage Structs
 * @date 2015-03-31
 */
/**
 * This class stands for EzCatalogoStructPacote originally named Pacote
 * @package EzCatalogo
 * @subpackage Structs
 * @date 2015-03-31
 */
class EzCatalogoStructPacote extends EzCatalogoWsdlClass
{
    /**
     * The CodigoBarra
     * @var string
    ...
    /**
     * The PacoteProdutos
     * @var EzCatalogoStructArrayOfPacoteProduto
     */
     ...
     * @param int $_pacoteID
     * @param EzCatalogoStructArrayOfPacoteProduto $_pacoteProdutos
     * @param int $_pedidoCodigo
     * @param int $_trackingStatus
     * @return EzCatalogoStructPacote
     */
     ...
     * @return EzCatalogoStructArrayOfPacoteProduto|null
     */
     ...
     * @param EzCatalogoStructArrayOfPacoteProduto $_pacoteProdutos the PacoteProdutos
